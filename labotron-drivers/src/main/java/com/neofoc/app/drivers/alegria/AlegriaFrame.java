...
public class AlegriaFrame extends AstmFrame {
...
MSG7	No	data	(EOT)
    ...
    public AlegriaFrame(FocInstrument instrument) {
        super(instrument);
    }
...
//    @Override
    public boolean extractAnswerFromBuffer_NOT_USED(StringBuffer buffer) {
        Globals.logString("AlegriaDriver extractAnswerFromBuffer");
